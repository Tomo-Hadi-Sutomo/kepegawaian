    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Pengumuman Add</h3>
            </div>
			<?php echo form_open('pengumuman/add'); ?>
            <div class="box-body">
                <div class="row clearfix">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="checkbox" name="diterima" value="1" id="diterima"/> <label for="diterima"
                                                                                                    class="control-label">Diterima</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="nilai_pengetahuan"
                                   value="<?php echo $this->input->post('nilai_pengetahuan'); ?>" class="form-control"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="nilai_psikotes"
                                   value="<?php echo $this->input->post('nilai_psikotes'); ?>" class="form-control"
                                   id="nilai_psikotes"/>
                        </div>
                    </div>
                    <div class="col-md-6">
